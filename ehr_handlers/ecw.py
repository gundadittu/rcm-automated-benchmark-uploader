...
def handle_ecw():
  ...
  if uploaded_file is not None:
      ...
      #   cpt_col=cpt_col
      # )
      st.button('Generate Benchmark', on_click=compute_ecw_stats, args=(
        df,
        insurer_col,
        primary_col,
        total_payment_col,
        insurance_payout_col,
        patient_payment_col,
        claim_no_col,
        cpt_col
      ))